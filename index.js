...
🔒 **Політика приватності для Telegram-бота Znaimo**  
_Оновлено: 24 травня 2025_
...
**2. Дані, які ми ЗБИРАЄМО і ЗБЕРІГАЄМО**  
• **Особисті дані Telegram**: ID, ім’я, юзернейм  
• **Дані анкети**: ім’я, вік, стать, місто, “Про себе”, фото (file_id), параметри пошуку  
• **Метадані**: час створення/оновлення анкети
• **Лайки/дизлайки**: кому ви ставили і хто вам ставив 💝/❌  
...
**6. Видалення даних**  
• Команда \`/delete\` (поки не реалізовано)  
